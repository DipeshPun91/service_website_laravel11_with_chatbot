            ...
            <div class="content">
                ...
                <section class="text-gray-600 body-font">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Edit New Image</h1>
                        <div class="h-1 w-20 bg-yellow-500 rounded mx-auto"></div>
                    </div>

                    <div class="flex items-center justify-center">
                        <div class="container w-[500px] h-auto p-8">
                            <form action="{{ route('update.photo', $photo->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label for="photo" class="block text-gray-700 font-medium mb-2">Update Photo</label>

                                    <div id="old-image-container" class="mb-4">
                                        <img src="{{ asset($photo->path) }}" alt="{{ $photo->title }}" class="w-full h-auto rounded-lg">
                                    </div>
